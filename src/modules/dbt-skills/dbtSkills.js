...
export const dbtSkills = [
  // ==================== ACHTSAMKEIT ====================
  {
    ...
    fullDescription:
      'Der Wise Mind ist der Zustand, in dem emotionaler und rationaler Geist zusammenarbeiten. Er ermöglicht kluge Entscheidungen, die sowohl Gefühle als auch Fakten berücksichtigen.',
    whenToUse: [
  ...
  },
  {
    ...
    fullDescription:
      'Innere und äußere Erfahrungen wahrnehmen, ohne sie zu bewerten oder zu verändern. Wie Wolken am Himmel beobachten - sie kommen und gehen.',
    whenToUse: [
    ...
    steps: [
      ...
      {
        title: 'Beobachten',
        instruction: 'Beobachte Gedanken und Gefühle wie vorbeiziehende Wolken',
      },
      {
        title: 'Zurückkehren',
        instruction: 'Wenn du abschweifst, kehre sanft zum Beobachten zurück',
      },
    ],
    difficulty: 1,
    effectiveness: { acute: 3, longterm: 5 },
  ...
  },
  {
    ...
    fullDescription:
      '"Name it to tame it" - Durch das Benennen von Gefühlen und Gedanken verlieren sie an Intensität. Objektiv beschreiben, ohne zu interpretieren.',
    whenToUse: [
  ...
  },
  {
    ...
    fullDescription:
      'Mono-Tasking statt Multi-Tasking. Eine Tätigkeit mit ganzer Aufmerksamkeit ausführen, ohne nebenbei anderes zu tun.',
    whenToUse: [
      'Bei Überforderung',
  ...
  // ==================== STRESSTOLERANZ ====================
  {
    ...
    fullDescription:
      'Ein Akronym für akute Situationen: Stop - Take a step back - Observe - Proceed mindfully. Verhindert impulsive Reaktionen.',
    acronym: {
  ...
  },
  {
    ...
    fullDescription:
      'Physiologische Übungen, die das Nervensystem schnell beruhigen. Besonders wirksam bei Panik oder extremem emotionalen Stress.',
    acronym: {
    ...
    steps: [
      {
        title: 'T - Temperatur',
        instruction:
          'Halte dein Gesicht 30 Sek. in kaltes Wasser oder lege Eiswürfel auf Nacken/Handgelenke',
        scienceNote: 'Aktiviert den Tauchreflex, senkt Herzfrequenz',
      },
      {
        title: 'I - Intensive Bewegung',
        instruction: 'Sprinte, mach Jumping Jacks, Treppen steigen - 10-15 Minuten',
        scienceNote: 'Baut Stresshormone ab',
      },
      {
        title: 'P - Paced Breathing',
        instruction: '4 Sekunden einatmen, 6-8 Sekunden ausatmen. 5-10 Minuten',
        scienceNote: 'Aktiviert Parasympathikus',
      },
      {
        title: 'P - Progressive Muskelentspannung',
        instruction: 'Muskelgruppen nacheinander anspannen (5 Sek.) und loslassen',
      },
    ],
    difficulty: 1,
  ...
  },
  {
    ...
    fullDescription:
      'Verschiedene Ablenkungstechniken für extremen emotionalen Schmerz. Kurzfristige Strategie - das Problem später angehen!',
    acronym: {
  ...
  },
  {
    ...
    fullDescription:
      'Skills, um eine schwere Situation erträglicher zu gestalten, ohne sie zu vermeiden.',
    acronym: {
  ...
  },
  {
    ...
    fullDescription:
      'Die Realität akzeptieren, wie sie ist - nicht gutheißen, sondern anerkennen. Schmerz + Nicht-Akzeptanz = Leiden. Schmerz + Akzeptanz = nur Schmerz.',
    whenToUse: [
  ...
  // ==================== EMOTIONSREGULATION ====================
  {
    ...
    fullDescription:
      'Prüfen, ob die Stärke und Art der Emotion zur Situation passt. Automatische Gedanken und Interpretationen hinterfragen.',
    whenToUse: [
  ...
  },
  {
    ...
    fullDescription:
      'Das Gegenteil des emotionalen Impulses tun, wenn die Emotion nicht zur Situation passt oder nicht hilfreich ist.',
    whenToUse: [
  ...
  },
  {
    ...
    fullDescription:
      'Langfristige Strategien, um emotionale Verletzlichkeit zu reduzieren und Resilienz aufzubauen.',
    acronym: {
    ...
    steps: [
      ...
      {
        title: 'C - Vorausplanen',
        instruction: 'Überlege: Was könnte schwierig werden? Wie gehe ich damit um?',
      },
      {
        title: 'PLEASE',
        instruction: 'Achte auf Grundbedürfnisse: Schlaf, Essen, Bewegung, keine Substanzen',
      },
    ],
    difficulty: 2,
    effectiveness: { acute: 2, longterm: 5 },
  ...
  },
  {
    ...
    fullDescription:
      'Emotionen bewusst fühlen und durchleben, ohne sie zu bekämpfen oder zu verstärken. Sie kommen und gehen wie Wellen.',
    whenToUse: [
  ...
  // ==================== ZWISCHENMENSCHLICH ====================
  {
    ...
    fullDescription:
      'Strukturierter Leitfaden, um Wünsche zu äußern oder Nein zu sagen, während man die Beziehung pflegt.',
    acronym: {
    ...
    whenToUse: ['Um Wünsche zu äußern', 'Um Nein zu sagen', 'In Verhandlungen', 'Bei Konflikten'],
    steps: [
  ...
  },
  {
    ...
    fullDescription:
      'Skills, um die Beziehung zum Gegenüber zu pflegen, besonders wenn das Beziehungsziel wichtiger ist als das eigene Durchsetzen.',
    acronym: {
    ...
    steps: [
      ...
      {
        title: 'V - Validate',
        instruction: 'Bestätige die Gefühle des anderen: "Ich verstehe, dass..."',
      },
  ...
  },
  {
    ...
    fullDescription:
      'Skills, um die eigene Selbstachtung zu bewahren, besonders in schwierigen Gesprächen.',
    acronym: {
    ...
    steps: [
      ...
      {
        title: 'A - No Apologies',
        instruction: 'Entschuldige dich nicht übermäßig für berechtigte Wünsche',
      },
...
export const situationTypes = [
  { id: 'crisis', label: 'Akute Krise', icon: '🚨', priority: ['tipp', 'stop', 'accepts'] },
  {
    ...
    label: 'Angst / Panik',
    icon: '😰',
    priority: ['tipp', 'opposite-action', 'check-the-facts'],
  },
  {
    id: 'sadness',
    label: 'Traurigkeit / Depression',
    icon: '😢',
    priority: ['opposite-action', 'abc-please', 'ride-the-wave'],
  },
  {
    id: 'anger',
    label: 'Wut / Ärger',
    icon: '😠',
    priority: ['stop', 'opposite-action', 'check-the-facts'],
  },
  {
    id: 'overwhelm',
    label: 'Überforderung',
    icon: '😵',
    priority: ['stop', 'one-mindfully', 'tipp'],
  },
  {
    id: 'conflict',
    label: 'Konflikt / Streit',
    icon: '💢',
    priority: ['dear-man', 'give', 'stop'],
  },
  {
    id: 'boundary',
    label: 'Grenzen setzen',
    icon: '🛑',
    priority: ['dear-man', 'fast', 'check-the-facts'],
  },
  {
    id: 'rumination',
    label: 'Grübeln / Sorgen',
    icon: '🌀',
    priority: ['beobachten', 'one-mindfully', 'accepts'],
  },
  {
    id: 'shame',
    label: 'Scham / Schuld',
    icon: '😳',
    priority: ['opposite-action', 'check-the-facts', 'radical-acceptance'],
  },
  {
    id: 'urge',
    label: 'Starker Drang',
    icon: '⚡',
    priority: ['tipp', 'accepts', 'ride-the-wave'],
  },
  {
    id: 'loss',
    label: 'Verlust / Trauer',
    icon: '💔',
    priority: ['radical-acceptance', 'ride-the-wave', 'improve'],
  },
  {
    id: 'daily',
    label: 'Tägliche Übung',
    icon: '🌱',
    priority: ['beobachten', 'one-mindfully', 'abc-please'],
  },
]
