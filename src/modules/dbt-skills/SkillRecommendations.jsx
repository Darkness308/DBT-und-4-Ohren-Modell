...
import { dbtModules } from './dbtSkills'
  ...
  return (
    <div className="space-y-4 animate-fade-in">
      ...
      <div className="bg-calm-50 rounded-xl p-4 border border-calm-200">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">Intensität: {intensity.label}</p>
          </div>
        </div>
      </div>
      ...
      {secondarySkills.length > 0 && (
        <div>
          <h3 className="text-md font-medium text-gray-600 mb-3">Weitere passende Skills</h3>
          <div className="space-y-3">
