...
import { vierOhrenExamples } from './vierOhrenExamples'
  ...
  validateUserAnswer(exercise, answer) {
    ...
    if (completedLevels === 4) {
      ...
      feedback.encouragement =
        'Toll! Du hast alle vier Ebenen berücksichtigt. Das ist eine wichtige Fähigkeit für bessere Kommunikation.'
    } else if (completedLevels >= 2) {
      feedback.overall = 'good'
      feedback.encouragement =
        'Guter Ansatz! Versuche noch die fehlenden Ebenen zu berücksichtigen.'
    } else {
      feedback.overall = 'needs_work'
      feedback.encouragement =
        'Das Vier-Ohren-Modell braucht Übung. Keine Sorge - mit der Zeit wird es leichter!'
    }
