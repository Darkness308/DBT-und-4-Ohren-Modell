...
import { dbtSkills, dbtModules } from '../dbt-skills/dbtSkills'
...
export default function SkillOfTheDay() {
  ...
  return (
    <div
      className={`bg-gradient-to-br ${moduleColors[skill.module]} rounded-xl p-6 text-white shadow-lg animate-fade-in`}
    >
      ...
      <p className="text-white/90 text-sm mb-4">{skill.shortDescription}</p>
