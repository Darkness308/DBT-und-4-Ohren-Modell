...
function ActivityItem({ item }) {
  ...
  return (
    <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
      {/* Icon */}
      <div
        className={`w-10 h-10 rounded-full flex items-center justify-center ${moduleColors[item.module] || 'bg-gray-100 text-gray-600'}`}
      >
      ...
      <div className="flex-1 min-w-0">
        <p className="font-medium text-gray-800 truncate">{item.skillName || item.skillId}</p>
