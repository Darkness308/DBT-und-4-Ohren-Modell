    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-md p-6 animate-fade-in">
        ...
        <p className="text-gray-600 leading-relaxed">
          Jede Nachricht hat vier Seiten: <strong>Sachinhalt</strong>, <strong>Selbstoffenbarung</strong>,{' '}
          <strong>Beziehung</strong> und <strong>Appell</strong>. Analysiere Aussagen, um
          Missverständnisse zu erkennen und besser zu kommunizieren.
        </p>
      </div>
