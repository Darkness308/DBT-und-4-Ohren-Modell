    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-md p-6 animate-fade-in">
        ...
        <p className="text-gray-600 leading-relaxed">
          Beschreibe deine aktuelle Situation und wie intensiv sie sich anfühlt.
          Der Skill-Finder empfiehlt dir passende <strong>DBT-Skills</strong> aus den
          Bereichen Achtsamkeit, Stresstoleranz, Emotionsregulation und
